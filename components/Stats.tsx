...
export default function Stats() {
  return (
    <div className="relative z-10 max-w-[1180px] mx-auto px-5 md:px-14 pb-10 md:pb-[72px]">
      <div className="grid grid-cols-2 md:grid-cols-4 border border-[#e8e8e4] rounded-[18px] overflow-hidden bg-[#e8e8e4] gap-px">
        {stats.map((s) => (
